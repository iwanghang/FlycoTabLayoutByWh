...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d("byWhSt", "SlidingTabLayout #1");
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        Log.d("byWhSt", "obtainAttributes #2");
        ...
        Log.d("byWhSt", "mTextSelectSize=" + mTextSelectSize);
        Log.d("byWhSt", "mTextUnselectSize=" + mTextUnselectSize);
    ...
    public void notifyDataSetChanged() {
        Log.d("byWhSt", "notifyDataSetChanged");
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(i == mCurrentTab ? mTextSelectSize : mTextUnselectSize);
    ...
    private void scrollToCurrentTab() {
        Log.d("byWhSt", "scrollToCurrentTab");
        if (mTabCount <= 0) {
            return;
        }
    ...
    private void updateTabSelection(int position) {
        Log.d("byWhSt", "updateTabSelection");
        for (int i = 0; i < mTabCount; ++i) {
    ...
    private void calcIndicatorRect() {
        Log.d("byWhSt", "calcIndicatorRect");
